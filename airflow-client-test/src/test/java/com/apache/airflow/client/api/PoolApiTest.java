 ...
 */
public class PoolApiTest extends BasicApiClientAuthenticator {

    private final PoolApi api = new PoolApi();
    private final String poolName = "default_pool";
    ...
    public void getPoolTest() throws ApiException {
        ...
        assertEquals(poolName, response.getName());
    }
    ...
    public void postPoolTest() throws ApiException {
        Pool pool = api.getPool(poolName);
